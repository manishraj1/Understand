...
# ---------------------------------------------------------------------------
K0B_PROBE = (
    "RESTATE_COST_STRUCTURE: Before solving anything, restate the scoring "
    "rules of this task in exactly this format and nothing else:\n"
    "CORRECT:+<points>; THINK:-<points>/100tok; ANSWER:-<points>/word; "
    "WRONG:-<points>\n"
    "If a component was not specified, write 0 for it.\n"
)
